...
namespace Zulu.Threading.ThreadPools
{
    public sealed class ExtendedThreadPool : IExtendedThreadPool
    {
        ...
        private ExtendedThreadPool(Builder builder)
        {
            ...
            MultiThreadingCapacityType = builder.MultiThreadingCapacityType;
        ...
        /// </summary>
        public MultiThreadingCapacityType MultiThreadingCapacityType { get; private set; }
        ...
        {
            switch (builder.MultiThreadingCapacityType)
            {
                ...
                default:
                    string error = string.Format(
                        "Invalid MultiThreadingCapacityType: {0}", builder.MultiThreadingCapacityType);
        ...
        public sealed class Builder
        {
            public Builder()
            {
                ...
                MinThreads = 1;
                MaxThreads = 25;
                MultiThreadingCapacityType = MultiThreadingCapacityType.PerProcessor;
            ...
            public MultiThreadingCapacityType MultiThreadingCapacityType { get; set; }
            ...
            /// </summary>
            ///<remarks>Default value is <see cref="DefaultTaskQueueController" />.</remarks>
            ...
            {
                Validate();
                return new ExtendedThreadPool(this);
            }
